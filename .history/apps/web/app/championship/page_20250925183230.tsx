    ...
    <>
      ...
      <div className="championship-platform">
        ...
        <div className="header">
          <div className="brand-logo" onClick={() => window.goHome?.()}>
        ...
        <div id="universe-container">
          ...
          <div className="hud-overlay">
            ...
            <div className="control-panel">
              <button className="control-btn active" onClick={() => window.setUniverseMode?.('explore')}>Explore</button>
              <button className="control-btn" onClick={() => window.setUniverseMode?.('analytics')}>Analytics</button>
              <button className="control-btn" onClick={() => window.setUniverseMode?.('heatmap')}>Heat Map</button>
              <button className="control-btn" onClick={() => window.setUniverseMode?.('connections')}>Network</button>
              <button className="control-btn" onClick={() => window.toggleFullscreen?.()}>Fullscreen</button>
            </div>
